...
func CORS() echo.MiddlewareFunc {
	...
	return echomw.CORSWithConfig(echomw.CORSConfig{
		...
		AllowHeaders:     []string{echo.HeaderOrigin, echo.HeaderContentType, echo.HeaderAccept, echo.HeaderAuthorization, HeaderDeviceID, HeaderInterestIDs},
		ExposeHeaders:    []string{HeaderGuestToken, HeaderFeedRequestID},
